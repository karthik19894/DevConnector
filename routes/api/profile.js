...
//Get Profile of An User By Handle
...
router.delete(
	...
	passport.authenticate('jwt', { session: false }, (req, res) => {
		Profile.findOneAndRemove({ profile: req.user.profile }).then(() => {
			User.findOneAndRemove({ user: req.user }).then(() => {
